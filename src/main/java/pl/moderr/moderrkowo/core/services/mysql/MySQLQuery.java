            ...
            try {
                ...
                try {
                    for (int j = 0; j < ranking.size(); j++) {
                        ...
                        assert e != null;
                        e.setCustomName(ColorUtil.color("&f#" + (10 - j) + " &7Brak"));
                ...
                while (rs.next()) {
                    try {
                        ...
                        assert e != null;
                        e.setCustomName(ColorUtil.color("&f#" + (10 - i) + " &7" + rs.getString("NAME") + " &6" + ChatUtil.formatMoney(rs.getDouble("MONEY"))));
                    } catch (Exception e) {
...
//    }
    ...
    public void Query(String SQL) {
        try {
            ...
            Logger.logDatabaseMessage(ColorUtil.color("&cNie udało się wykonać zapytania"));
        }
    }
    ...
    public void insertUser(@NotNull User user) throws SQLException {
        ...
        preparedStatement.setString(7, user.getLevel().toString());
        preparedStatement.setString(8, user.getQuestData().toString());
    ...
    public void updateUser(@NotNull User user) throws SQLException {
        ...
        preparedStatement.setString(5, user.getLevel().toString());
        preparedStatement.setString(6, user.getQuestData().ToJson());
